# Containerfile
FROM ubuntu:24.04 # Or your preferred Linux distribution (e.g., fedora:39, debian:stable)
...
ENV ZELLIJ_VERSION="0.42.2" # Check https://github.com/zellij-org/zellij/releases
...
ENV HELIX_VERSION="25.01.1" # Check https://github.com/helix-editor/helix/releases
...
ENV YAZI_VERSION="25.5.31" # Check https://github.com/sxycode/yazi/releases
